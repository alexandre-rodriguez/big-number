...
export class InputService {
  ...
  applyMask(isNumber: boolean, rawValue: string): string {
    let { allowNegative, decimal, precision, prefix, suffix, thousands } =
      this.options;
  ...
  clearMask(rawValue: string): string | null {
  ...
  changeToPositive(): void {
    ...
    this.updateFieldValue(selectionStart - step);
  }
  ...
  getRawValueWithoutPrefixStartPosition(): number {
    ...
    return this.value != null && value.isLessThan(this.zero)
